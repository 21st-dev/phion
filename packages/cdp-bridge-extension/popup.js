...
class PopupController {
  ...
  async updateUI() {
    ...
    if (error) {
      ...
      this.showStatus("connected", "This tab is currently shared with Phion")
  ...
  showConnectButton() {
    ...
    if (connectBtn) {
      ...
      const isValidUrl = this.bridgeUrlInput
        ? this.isValidWebSocketUrl(this.bridgeUrlInput.value)
        : false
