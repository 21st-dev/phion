...
export const API_ENDPOINTS = {
    ...
    PROJECT_VERSIONS: (id) => `/api/projects/${id}/versions`,
    PROJECT_DIFF: (id) => `/api/projects/${id}/diff`,
    PROJECT_REVERT: (id) => `/api/projects/${id}/revert`,
    PROJECT_DOWNLOAD: (id) => `/api/projects/${id}/download`,
    PROJECT_DEPLOY: (id) => `/api/projects/${id}/deploy`,
};
