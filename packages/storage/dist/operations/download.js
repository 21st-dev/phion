 ...
 */
export async function downloadTextFile(key) {
 ...
 * Скачать JSON файл
 */
export async function downloadJsonFile(key) {
 ...
 */
export async function downloadFileVersion(projectId, versionId, filePath) {
 ...
 */
export async function downloadProjectTemplate(projectId) {
 ...
 */
export async function downloadBuildArtifacts(projectId, buildId) {
 ...
 */
export async function downloadProjectFiles(projectId, versionId) {
