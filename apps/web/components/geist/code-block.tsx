...
export const CodeBlock = ({
  ...
  const onClick = () => {
    ...
    navigator.clipboard.writeText(
      typeof children === "string" ? children : children.reduce((prev, curr) => prev + "\n" + curr),
    )
  }
            ...
            <Button svgOnly type="tertiary" size="small" onClick={onClick}>
              <div className="h-4 w-4">
                <svg
                  ...
                  viewBox="0 0 16 16"
                  width="16"
                  className={`absolute z-10 fill-foreground ${
                ...
                <svg
                  ...
                  viewBox="0 0 16 16"
                  width="16"
                  className={`absolute top-0 left-1/2 -translate-x-1/2 opacity-0 fill-foreground ${
