...
export const Icons = {
  ...
  cursor: (props: LucideProps) => (
    <>
      <CursorLight {...props} className={`${props.className || ""} hidden dark:block`} />
      <CursorDark {...props} className={`${props.className || ""} dark:hidden`} />
    </>
  ),
  ...
  cursorLogo: (props: LucideProps) => (
    <svg fill="currentColor" viewBox="0 0 69 13" xmlns="http://www.w3.org/2000/svg" {...props}>
